...
parser.add_argument('--input_dir', default='../../datasets/test/Denoising_realworld/DND', type=str,
                    help='Directory of validation images')
parser.add_argument('--result_dir', default='../../test_results/Denoising_realworld/DND', type=str,
                    help='Directory for results')
parser.add_argument('--weights', default='D:/NCHU/thesis/Code/checkpoints/Denoise_realworld/models/model_bestPSNR.pth',
