...
if __name__ == "__main__":
    ...
    parser.add_argument('-dirA', default='../../test_results/LLEnhancement/LOL', type=str)
    parser.add_argument('-dirB', default='../../datasets/test/LLEnhancement/LOL/target', type=str)
