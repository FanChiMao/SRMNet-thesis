...
datasets = {'HIDE'}; % or HIDE

num_set = length(datasets);

for idx_set = 1:num_set
    fprintf('In process......\n')
    file_path = strcat('../../test_results/Deblurring_motionblur/', datasets{idx_set}, '/');
    gt_path = strcat('../../datasets/test/Deblurring_motionblur/', datasets{idx_set}, '/target/');
