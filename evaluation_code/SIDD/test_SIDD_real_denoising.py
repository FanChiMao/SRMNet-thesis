...
parser.add_argument('--input_dir', default='../../datasets/test/Denoising_realworld/SIDD', type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default='../../test_results/Denoising_realworld/SIDD', type=str, help='Directory for results')
parser.add_argument('--weights', default='D:/NCHU/thesis/Code/checkpoints/Denoise_realworld/models/model_bestPSNR.pth', type=str,
...
model_restoration = SRMNet_SWFF(in_chn=3, wf=96, depth=4)
