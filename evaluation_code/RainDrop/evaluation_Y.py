...
def get_args():
    ...
    parser.add_argument("--input_dir", default='../../test_results/Deraining_raindrop/RainDrop/test_a', type=str)
    parser.add_argument("--gt_dir", default='../../datasets/test/Deraining_raindrop/RainDrop/test_a/gt', type=str)
