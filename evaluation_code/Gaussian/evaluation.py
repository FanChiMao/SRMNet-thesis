...
if __name__ == "__main__":
    ...
    parser.add_argument('-dirA', default='../../test_results/Denoising_gaussian/CBSD68/50', type=str)
    parser.add_argument('-dirB', default='../../datasets/test/Denoising_gaussian/CBSD68/GT', type=str)
