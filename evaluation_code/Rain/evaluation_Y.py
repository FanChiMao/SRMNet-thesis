...
def get_args():
    ...
    parser.add_argument("--input_dir", default='../../test_results/Deraining_rainstreak/Test2800', type=str)
    parser.add_argument("--gt_dir", default='../../datasets/test/Deraining_rainstreak/Test2800/target', type=str)
